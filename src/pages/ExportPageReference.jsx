...
export default function ExportPageReference() {
  // Export page states
  ...
  const handlePreview = () => {
    ...
    const interval = setInterval(() => {
      setPlaybackProgress(prev => {
        ...
        return prev + 3.45; // ~29 seconds total
      });
  ...
  const handleSeek = (e) => {
    ...
    setPlaybackTime(Math.floor((percentage / 100) * 29));
  };
        ...
        <div style={styles.centerContent}>
          {!exportComplete ? (
            <>
              ...
              {/* Playback Controls - Only visible when previewing */}
              {isPreviewing && (
                <div style={styles.playbackControlsSection}>
                  {/* Progress Bar */}
                  <div style={styles.playbackProgressContainer}>
                    <span style={styles.playbackTimeLabel}>
                  ...
                  <div style={styles.playbackControls}>
                    ...
                    <div style={styles.playbackInfo}>
                      <span>Playing at {framerates.find(f => f.id === selectedFramerate)?.value}</span>
                      <span>•</span>
                      <span>{getResolutionSpecs()}</span>
                    </div>

                    <button 
                      style={styles.playbackButtonSecondary}
                      onClick={handleCast}
                      title="Cast to TV"
                    >
                      <Cast size={18} />

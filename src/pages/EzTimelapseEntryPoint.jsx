...
export default function EzTimelapseEntryPoint() {
    ...
    <div style={styles.container}>
      <style>
        {`
          ...
          @keyframes glowPulse {
            0%, 100% {
              box-shadow: 0 12px 48px rgba(167, 139, 250, 0.25), 0 0 40px rgba(167, 139, 250, 0.3);
            }
            50% {
              box-shadow: 0 12px 48px rgba(167, 139, 250, 0.35), 0 0 60px rgba(167, 139, 250, 0.5);
            }
          }
        ...
        <div style={styles.sidePanel}>
          ...
          <div style={styles.panelSection}>
            ...
            >
              ...
              {expandedSections.recent ? <ChevronUp size={18} /> : <ChevronDown size={18} />}
            </button>
          ...
          <div style={styles.heroContainer}>
            ...
            >
              ...
              <button 
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = 'scale(1.02)';
                  e.currentTarget.style.boxShadow = '0 6px 24px rgba(167, 139, 250, 0.35)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'scale(1)';
            ...
            <div style={styles.drawerContent}>
              <div style={styles.settingsSection}>
                ...
                >
                  ...
                  {expandedSettings.general ? <ChevronUp size={18} /> : <ChevronDown size={18} />}
                </button>
              ...
              <div style={styles.settingsSection}>
                ...
                >
                  ...
                  {expandedSettings.rendering ? <ChevronUp size={18} /> : <ChevronDown size={18} />}
                </button>
              ...
              <div style={styles.settingsSection}>
                ...
                >
                  ...
                  {expandedSettings.appearance ? <ChevronUp size={18} /> : <ChevronDown size={18} />}
                </button>
              ...
              <div style={styles.settingsSection}>
                ...
                >
                  ...
                  {expandedSettings.storage ? <ChevronUp size={18} /> : <ChevronDown size={18} />}
                </button>
          ...
          <div style={styles.upgradeModal}>
            ...
            <div style={styles.modalContent}>
              ...
              <button 
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = 'scale(1.02)';
                  e.currentTarget.style.boxShadow = '0 10px 32px rgba(167, 139, 250, 0.4)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'scale(1)';
...
const styles = {
  ...
  backgroundGradient: {
    ...
    right: 0,
    bottom: 0,
    background: 'linear-gradient(135deg, #FDE8F4 0%, #E0E7FF 25%, #DBEAFE 50%, #E0F2FE 75%, #F0FDFA 100%)',
    zIndex: 0,
  },
  topNav: {
    height: '64px',
  ...
  sidePanel: {
    ...
    overflowY: 'auto',
    flexShrink: 0,
    boxShadow: '4px 0 16px rgba(167, 139, 250, 0.08)',
  },
  panelSection: {
  ...
  tipsPanel: {
    margin: '16px 12px',
    padding: '14px',
    background: 'linear-gradient(135deg, rgba(254, 243, 199, 0.6) 0%, rgba(253, 224, 71, 0.3) 100%)',
    backdropFilter: 'blur(10px)',
    WebkitBackdropFilter: 'blur(10px)',
    border: '1px solid rgba(251, 191, 36, 0.3)',
    borderRadius: '10px',
  ...
  dropZoneDragging: {
    ...
    boxShadow: '0 12px 48px rgba(167, 139, 250, 0.25), 0 0 40px rgba(167, 139, 250, 0.3)',
  ...
  featureIcon: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    boxShadow: 'inset 0 1px 3px rgba(167, 139, 250, 0.1)',
  },
  featureContent: {
    display: 'flex',
    flexDirection: 'column',
  ...
  renderDetailsSheet: {
    ...
    border: '1px solid rgba(255, 255, 255, 0.8)',
    borderRadius: '16px',
    boxShadow: '0 12px 48px rgba(167, 139, 250, 0.25)',
    zIndex: 50,
  ...
  modalHeader: {
    ...
    textAlign: 'center',
    background: 'linear-gradient(135deg, rgba(253, 232, 244, 0.4) 0%, rgba(224, 231, 255, 0.4) 100%)',
  },
  modalTitle: {
    fontSize: '28px',
    fontWeight: '700',
